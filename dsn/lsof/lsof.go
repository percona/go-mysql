...
// This is a modified code based on https://raw.githubusercontent.com/keybase/client/master/go/lsof/lsof.go
package lsof
...
// Socket returns sockets used by pid.
func Socket(pid int32) ([]Process, error) {
	return run([]string{"-a", "-n", "-P", "-U", "-F", "pcuftn", "-p", fmt.Sprintf("%d", pid)})
}
